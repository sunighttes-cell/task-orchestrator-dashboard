...
//                    jobRepository.getStatusSummaryByUser(
//                            "testuser"
//                    );
//
//            assertThat(result)
...
//
//            List<StatusSummary> result =
//                    jobRepository.getStatusSummary();
//
//            assertThat(result)
//                    .hasSize(2);
//
...
//
//            long result =
//                    jobRepository.countActiveByUser(
//                            "testuser"
//                    );
//
//            assertThat(result)
...
//
//            long result =
//                    jobRepository.countActiveByStatus(
//                            JobStatus.QUEUED
//                    );
//
//            assertThat(result)
...
//
//            long result =
//                    jobRepository.countActiveByUserAndStatus(
//                            JobStatus.QUEUED,
//                            "testuser"
//                    );
//
...
//
//            List<Job> result =
//                    jobRepository.findNextJobsForUpdate(
//                            JobStatus.QUEUED,
//                            PageRequest.of(0, 1)
//                    );
//
...
//
//            List<Job> result =
//                    jobRepository.findNextJobsForUpdateByUser(
//                            JobStatus.QUEUED,
//                            PageRequest.of(0, 10),
//                            "testuser"
//                    );
...
//                    .hasSize(1);
//
//            assertThat(result.get(0).getUser().getUsername())
//                    .isEqualTo("testuser");
//        }
//    }
//
